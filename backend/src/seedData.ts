...
async function seed() {
  ...
  if (userCount > 0) {
    console.log(`Already ${userCount} users in database, skipping seed`);
  ...
  const courses = [
    {
      ...
      hierarchyId: 'HI001',
      description: '从零开始学习 Python 编程，掌握基本语法和编程思想。',
    ...
    {
      courseName: 'JavaScript 入门与进阶',
      hierarchyId: 'HI002',
      description: '系统学习 JavaScript 语言，包括 ES6+ 新特性、前端开发实战。',
    ...
    },
    {
      courseName: '数据结构与算法',
      hierarchyId: 'HI003',
      description: '深入学习常见数据结构（链表、树、图）和算法（排序、搜索、动态规划）。',
    ...
    },
    {
      courseName: '机器学习基础',
      hierarchyId: 'HI004',
      description: '介绍机器学习核心概念、常用算法（线性回归、决策树、神经网络）及 Python 实现。',
      coverImage: 'https://picsum.photos/seed/ml/400/300',
      totalLessons: 25,
      completedLessons: 0,
      duration: 1500,
      difficulty: 3,
    ...
    },
    {
      ...
      hierarchyId: 'HI005',
      description: '基于 React + TypeScript + Tailwind CSS 构建现代化 Web 应用。',
    ...
    },
    {
      courseName: '数据库设计与优化',
      hierarchyId: 'HI006',
      description: '学习关系型数据库设计、SQL 查询优化、索引原理及 NoSQL 应用。',
      coverImage: 'https://picsum.photos/seed/database/400/300',
      totalLessons: 15,
      completedLessons: 0,
      duration: 900,
      difficulty: 3,
    ...
    },
    {
      courseName: 'C++ 程序设计',
      hierarchyId: 'HI007',
      description: '面向对象编程基础、C++ 标准库、多线程编程入门。',
      coverImage: 'https://picsum.photos/seed/cpp/400/300',
      totalLessons: 22,
      completedLessons: 0,
      duration: 1320,
      difficulty: 3,
    ...
    },
    {
      courseName: '算法竞赛入门',
      hierarchyId: 'HI008',
      description: '为零基础学生设计的算法竞赛入门课程，涵盖基础算法和竞赛技巧。',
      coverImage: 'https://picsum.photos/seed/algorithm/400/300',
      totalLessons: 16,
      completedLessons: 0,
      duration: 960,
      difficulty: 2,
  ...
  for (const course of courses) {
    const saved = await courseRepo.save(courseRepo.create(course));
  ...
  for (const course of savedCourses) {
    ...
    if (template) {
      for (let i = 0; i < template.length; i++) {
        ...
        console.log(`Created lesson: ${course.courseName} - ${template[i].lessonName}`);
      }
    }
  }

  console.log(`\nSeeded ${users.length} users, ${courses.length} courses successfully!`);
  await dataSource.destroy();
}
